...
public final class ViewfinderView extends View {
  ...
  public void onDraw(Canvas canvas) {
    ...
    if (resultBitmap != null) {
      ...
      //Log.d("overlay","Scale scale x scale y " + scaleX + " " + scaleY + "frame width" + frame.width() + " preview" + (float) previewFrame.width() );
      ...
      Log.d("i",frame.left+" "+frame.right +" " +frame.top +" " +frame.bottom);
